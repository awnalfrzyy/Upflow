    ...
    return (
        <FullBleed className="overflow-x-hidden">
            ...
            <div className="min-h-screen flex items-center relative">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-40 py-12 md:py-20">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <motion.div
                        ...
                        {cardFeatures.map((feature, i) => (
                            <div
                                key={i}
                                className="flex flex-col items-center text-center gap-6 p-6 border-none rounded-3xl bg-transparent hover:bg-[#F9F9F9] transition"
                            >
                                <div className="w-28 h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 flex items-center justify-center">
                                    <Image
                                        src={feature.image}
                                        alt={feature.title}
                                        width={160}
            ...
            <div className="min-h-screen flex items-center relative overflow-hidden">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-40 py-12 md:py-20 z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        <motion.div
                            initial={{ opacity: 0, x: -50 }}
                        ...
                        >
                            ...
                            <div className="flex gap-4 items-start">
                                ...
                                <div className="flex flex-col">
                                    <h2 className="text-lg sm:text-xl font-semibold text-black mb-2">Cost Effective</h2>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    className="bg-[#5236FF] w-48 sm:w-56 md:w-72 lg:w-96 h-[300px] sm:h-[380px] md:h-[500px] lg:h-[600px] rounded-tl-3xl rounded-bl-3xl absolute right-0 top-1/2 -translate-y-1/2 z-0"
                />
                ...
                <motion.div
                    ...
                    className="absolute right-4 sm:right-6 md:right-10 lg:right-16 top-1/2 -translate-y-1/2 z-10">
                    <Image
                        src="/Image(1).svg"
                        alt="illustration"
                        width={500}
            ...
            {/* PRICING SECTION */}
            <div className="min-h-screen py-12 md:py-20 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* TESTIMONIAL SECTION */}
            <div className="min-h-screen bg-[#5236FF] flex flex-col items-center justify-center py-12 md:py-20 text-white overflow-hidden">
                <motion.div
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                ...
                >
                    <div className="text-center mb-8 md:mb-12">
                        <Button variant="disabled" className="bg-white text-[#5236FF] hover:bg-white/90 mb-4">
                            Testimonial
                        </Button>
                    ...
                    <div className="relative w-full max-w-4xl mx-auto flex items-center justify-center px-12 sm:px-16">
                        ...
                        >
                            <ChevronLeft className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-white" />
                        </Button>
                            ...
                            >
                                {testimonials.map((item, i) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-base sm:text-lg lg:text-xl italic max-w-2xl leading-relaxed">
                                            "{item.text}"
                                        </p>
                                        <h3 className="font-semibold text-base sm:text-lg mt-4 text-white/90">
                                            — {item.name}
                                        </h3>
                                    </div>
                                ))}
                        ...
                        >
                            <ChevronRight className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-white" />
                        </Button>
                    </div>
                </motion.div>
            </div>
